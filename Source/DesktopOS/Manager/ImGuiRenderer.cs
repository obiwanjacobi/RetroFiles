...
/// <summary>
/// Manages rendering ImGui in a monogame/Xna context.
/// Taken from ImGuiNET Xna sample.
/// </summary>
internal sealed class ImGuiRenderer
{
    ...
    private void RenderDrawData(ImDrawDataPtr drawData)
    {
        ...
        _graphics.BlendFactor = Microsoft.Xna.Framework.Color.White;
        ...
        // Setup projection
        _graphics.Viewport = new Viewport(0, 0, 
            _graphics.PresentationParameters.BackBufferWidth, 
            _graphics.PresentationParameters.BackBufferHeight);
    ...
    private unsafe void UpdateBuffers(ImDrawDataPtr drawData)
    {
        ...
        if (drawData.TotalVtxCount > _vertexBufferSize)
        {
            ...
            _vertexBuffer = new VertexBuffer(_graphics, DrawVertexDeclaration.Declaration, _vertexBufferSize, BufferUsage.None);
        ...
        for (int n = 0; n < drawData.CmdListsCount; n++)
        {
            ...
            fixed (void* idxDstPtr = &_indexData![idxOffset * sizeof(ushort)])
            {
                Buffer.MemoryCopy((void*)cmdList.VtxBuffer.Data, vtxDstPtr, 
                    _vertexData.Length, cmdList.VtxBuffer.Size * DrawVertexDeclaration.Size);
...
internal static class DrawVertexDeclaration
{
